...
b_loose_eff = tag_eff_file.Get('efficiency_btag_mwp')
c_loose_eff = tag_eff_file.Get('efficiency_ctag_mwp')
udsg_loose_eff = tag_eff_file.Get('efficiency_lighttag_mwp')
