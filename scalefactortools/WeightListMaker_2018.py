...
pileup2017histo=pileup2017file.Get('pileup')
...
eleRecoSFsFile_ptgt_20 = TFile('data_2018/electron_Reco_SFs_egammaEffi_txt_EGM2D_2017.root')
...
eleLooseIDSFsFile = TFile('data_2018/electron_Loose_ID_SFs_egammaEffi_txt_EGM2D_2017.root')
eleLooseIDSF_EGamma_SF2D = eleLooseIDSFsFile.Get('EGamma_SF2D')

#Tight Electron ID SFs
eleTightIDSFsFile = TFile('data_2018/electron_Tight_ID_SFs_egammaEffi_txt_EGM2D_2017.root')
eleTightIDSF_EGamma_SF2D = eleTightIDSFsFile.Get('EGamma_SF2D')

#Tight photon ID SFs
phoTightIDSFsFile = TFile('data_2018/photon_Tight_ID_SFs_egammaEffi_txt_EGM2D_2017.root')
phoTightIDSF_EGamma_SF2D = phoTightIDSFsFile.Get('EGamma_SF2D')

#Loose photon ID SFs
phoLooseIDSFsFile = TFile('data_2018/photon_Loose_ID_SFs_egammaEffi_txt_EGM2D_2017.root')
...
#Muon ID SFs
muonIDSFsBCDEFFile = TFile('data_2018/muon_ID_SFs_EfficienciesAndSF_BCDEF_2017.root')
...
#for low pt muons
muonIDSFsBCDEFFile_lowpt = TFile('data_2018/Muon_low-pT_RunBCDEF_SF_ID_JPsi_2017.root')
...
metTrigEff_secondfile = TFile('data_2018/metTriggerEfficiency_recoil_monojet_TH1F_2016.root')
...
for sf in sf_list:
    ...
    if (sf_list_dict[sf]=='muonTrackingSFs_EfficienciesAndSF_BCDEFGH')or (sf_list_dict[sf]=='pileup2017histo') or (sf_list_dict[sf]=='metTrig_firstmethod') or (sf_list_dict[sf]=='metTrig_secondmethod'):
